    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviesTags", x => new { x.MoviesListMovieId, x.TagsListTagId });
                    table.ForeignKey(
                        name: "FK_MoviesTags_Movies_MoviesListMovieId",
                        column: x => x.MoviesListMovieId,
                        principalTable: "Movies",
                        principalColumn: "MovieId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MoviesTags_Tags_TagsListTagId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoviesTags_TagsListTagId",
                table: "MoviesTags",
